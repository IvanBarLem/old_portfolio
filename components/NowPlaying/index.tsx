...
import { NowPlayingSongProps } from "lib/types";

import { FlexContainer, PlayingWrapper } from "components/NowPlaying/styles";

export default function NowPlaying() {
  /* const { data } = useSWR<NowPlayingSongProps>("/api/now-playing", fetcher); */
