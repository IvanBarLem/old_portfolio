  ...
  return (
    <Container title="Blog - Lasha Kakabadze">
      ...
      <Paragraph>
        ...
        El principal objetivo de estos blogs son la elaboración de una{" "}
        <i>memoria</i>
        de todos los trabajos realizados, de esta manera refuerzo el progreso y
        apoyo la formación que estoy teniendo. Como son de ayuda para mí,
        también lo pueden ser para otras personas, por este motivo he decidido
        compartirlos, espero que te sean de ayuda y que aprendas algo nuevo.
      </Paragraph>
